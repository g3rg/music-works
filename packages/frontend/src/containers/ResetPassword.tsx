    ...
    function renderRequestCodeForm() {
        return (
            <form onSubmit={handleSendCodeClick}>
                <FormGroup bsPrefix="large" controlId="email">
    ...
    function renderConfirmationForm() {
        return (
            <form onSubmit={handleConfirmClick}>
                <FormGroup bsPrefix="large" controlId="code">
                ...
                <hr />
                <FormGroup bsPrefix="large" controlId="password">
                ...
                <FormGroup bsPrefix="large" controlId="confirmPassword">
